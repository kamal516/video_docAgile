...
class Doneappointment extends StatefulWidget {
  ...
  Doneappointment({this.size,this.doctoremail,this.appointmenttime,this.appointmentdate,this.doctorname, this.onComplete});
  @override
...
class CheckPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _paint.color = buttonTextColor.withOpacity(.30);
